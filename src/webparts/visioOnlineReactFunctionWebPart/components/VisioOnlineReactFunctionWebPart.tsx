...
export default class VisioOnlineReactFunctionWebPart extends React.Component<IVisioOnlineReactFunctionWebPartProps, {}> {
  public render(): React.ReactElement<IVisioOnlineReactFunctionWebPartProps> {
    return (
